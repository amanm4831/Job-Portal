                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <select name="jobType" id="jobType" class="form-select" required>
                                            ...
                                            @foreach ($jobTypes as $jobType)
                                                <option {{($job->job_types_id==$jobType->id)?'selected':''}} value="{{ $jobType->id }}">{{ $jobType->name }}</option>
                                            @endforeach
                                        </select>
                                        <p class="text-danger small"></p>
                                    </div>
                ...
                success: function(response) {
                    if (response.status === true) {
                        ...
                        $.each(errors, function(key, message) {
                            let field = $('#' + key);
                            if (message) {
                                field.addClass('is-invalid').siblings('p').addClass('invalid-feedback').html(message);
                            } else {
